...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-15 10:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5e2304a9-9c3e-4f7a-adec-09df324104cf.git
$ cd 5e2304a9-9c3e-4f7a-adec-09df324104cf
```
